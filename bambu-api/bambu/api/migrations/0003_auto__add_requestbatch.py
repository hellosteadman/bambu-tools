...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('api_requestbatch', (
            ...
            ('app', self.gf('django.db.models.fields.related.ForeignKey')(related_name='requests', to=orm['api.App'])),
            ('time', self.gf('django.db.models.fields.DateTimeField')()),
            ('count', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
        ))
        db.send_create_signal('api', ['RequestBatch'])
    ...
    models = {
        ...
        'api.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1361199100L'}),
