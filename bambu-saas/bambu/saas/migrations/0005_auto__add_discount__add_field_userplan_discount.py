...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('saas_discount', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('description', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('percent', self.gf('django.db.models.fields.FloatField')()),
            ('months', self.gf('django.db.models.fields.PositiveIntegerField')(default=1)),
            ('code', self.gf('django.db.models.fields.CharField')(unique=True, max_length=50)),
            ('valid_yearly', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('saas', ['Discount'])

        # Adding field 'UserPlan.discount'
        db.add_column('saas_userplan', 'discount', self.gf('django.db.models.fields.related.ForeignKey')(related_name='user_plans', null=True, to=orm['saas.Discount']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Discount'
        db.delete_table('saas_discount')

        # Deleting field 'UserPlan.discount'
        db.delete_column('saas_userplan', 'discount_id')
    ...
    models = {
        ...
        'saas.userplan': {
            ...
            'discount': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'user_plans'", 'null': 'True', 'to': "orm['saas.Discount']"}),
