...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('blog_post', 'title', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Post.title'
        db.alter_column('blog_post', 'title', self.gf('django.db.models.fields.CharField')(default=u'(Untitled)', max_length=100))
