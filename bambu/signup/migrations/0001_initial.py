...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('signup_emailvalidation', (
            ...
            ('next_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
        ...
        db.send_create_signal('signup', ['EmailValidation'])

        # Adding model 'PasswordReset'
        db.create_table('signup_passwordreset', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='password_resets', unique=True, to=orm['auth.User'])),
            ('guid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36)),
            ('next_url', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True)),
            ('sent', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('signup', ['PasswordReset'])


    def backwards(self, orm):
        # Deleting model 'EmailValidation'
        db.delete_table('signup_emailvalidation')

        # Deleting model 'PasswordReset'
        db.delete_table('signup_passwordreset')
    ...
    models = {
        ...
        'signup.emailvalidation': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'next_url': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
