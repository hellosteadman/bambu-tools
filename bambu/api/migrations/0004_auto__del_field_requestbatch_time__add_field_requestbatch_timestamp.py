...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'RequestBatch.time'
        db.delete_column('api_requestbatch', 'time')

        # Adding field 'RequestBatch.timestamp'
        db.add_column('api_requestbatch', 'timestamp',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'RequestBatch.time'
        db.add_column('api_requestbatch', 'time',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 3, 23, 0, 0)),
                      keep_default=False)

        # Deleting field 'RequestBatch.timestamp'
        db.delete_column('api_requestbatch', 'timestamp')
    ...
    models = {
        ...
        'api.token': {
            ...
            'key': ('django.db.models.fields.CharField', [], {'max_length': '18'}),
            'secret': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'timestamp': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1364057303L'}),
