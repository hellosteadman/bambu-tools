...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Page.menu_groups'
        db.add_column('pages_page', 'menu_groups',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Page.menu_groups'
        db.delete_column('pages_page', 'menu_groups')
    ...
    models = {
        ...
        'pages.page': {
            'Meta': {'ordering': "('order_hierarchical',)", 'object_name': 'Page'},
            'author': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'pages'", 'to': "orm['auth.User']"}),
            ...
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'order': ('django.db.models.fields.PositiveIntegerField', [], {'default': '0', 'max_length': '2'}),
