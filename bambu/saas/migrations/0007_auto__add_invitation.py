...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('saas_invitation', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('guid', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('sender', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitations_sent', to=orm['auth.User'])),
            ('plan', self.gf('django.db.models.fields.related.ForeignKey')(related_name='invitations', to=orm['saas.UserPlan'])),
            ('email', self.gf('django.db.models.fields.EmailField')(unique=True, max_length=75)),
        ))
        db.send_create_signal('saas', ['Invitation'])


    def backwards(self, orm):
        # Deleting model 'Invitation'
        db.delete_table('saas_invitation')
