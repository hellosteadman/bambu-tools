...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'NewsletterOptInPending'
        db.create_table('auth_user_nloptins', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(related_name='pending_newsletter_optins', unique=True, to=orm['auth.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('saas', ['NewsletterOptInPending'])


    def backwards(self, orm):
        # Deleting model 'NewsletterOptInPending'
        db.delete_table('auth_user_nloptins')
